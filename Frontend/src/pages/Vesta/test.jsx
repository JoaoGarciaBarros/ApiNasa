...
import { getNasatrek } from '../../services/nasaClient'

export default function VESTATest() {
  ...
  async function handleFetch() {
    ...
    setError(null)
    try {
      setData(await getNasatrek(query))
    } catch (e) {
      setError(e.message)
    } finally {
      setLoading(false)
  ...
  return (
    <div className="flex flex-col items-center min-h-[calc(100vh-4rem)] px-6 py-10 gap-6">
      <h1 className="text-2xl font-semibold text-white">NASA Trek — Datasets</h1>
